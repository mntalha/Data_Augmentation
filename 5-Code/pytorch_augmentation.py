# -*- coding: utf-8 -*-
"""
Created on Thu Sep  9 11:34:50 2021
...
augmented_image = transforms_output(original_images[0])
...
for i in range(len(original_images)):
    augmented_images = transforms_output(original_images[i])
    visualize_keras(original_images[i],augmented_images)